...
namespace P01_BillsPaymentSystem.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("ALTER TABLE PaymentMethods ADD CONSTRAINT exd_check CHECK((BankAccountId IS NULL AND CreditCardId IS NOT NULL) OR (BankAccountId IS NOT NULL AND CreditCardId IS NULL))");
